...
class CTCPClientThread implements Runnable {
  ...
  /**
   * Steps: 1- Send out the payload 2- Set send_event to notify you are done sending 3- Receive
   * response (if any) 4- Set self.event to notify you are done receiving
   */
  @Override
  public void run() {
